...
import { Zap, Github, MessageCircle, Mail, Instagram } from 'lucide-react';
...
export function Footer() {
  ...
  const footerLinks = {
    ...
    legal: [
      ...
      { to: '/PowerSOL_Whitepaper_v1.0.6_(2)_(1).pdf', label: 'Whitepaper', isExternal: true },
    ],
    social: [
      ...
      { href: 'https://www.instagram.com/powersollottery/', icon: Instagram, label: 'Instagram' },
