...
const roadmapItems = [
  ...
  },
  {
    ...
    icon: Shield,
    title: 'Phase 3',
    description: 'TGE, Airdrop, Holders Lottery, NFT Special Draw, Certik Audit',
    status: 'upcoming',
  ...
  },
  {
    ...
    icon: Smartphone,
    title: 'Phase 4',
    description: 'DAO, Voting System, Affiliates Rewards Turn Holders Rewards, THE FUTURE IS YOURS',
    status: 'planned',
